...
#temp code
if (!exists("bc_popn")) load(glue(path,"/temp.RData"))
```
...
<details><summary>Click to see the R code for the Victoria CMA plots</summary>
...
The Statistics Canada data confirms what we hear all the time, the population in the Victoria CMA has been steadily increasing since 2001. But _not_ due to more kids&mdash;the population of 0 to 19 year olds steadily declined from 2001 until 2013-2014. This explains the decline in enrolment&mdash;and School District decisions to close schools at that time. However, 2014 marks a clear change&mdash;kid numbers are increasing. But what about in the Township of Esquimalt?
...
<details><summary>Click to see the R code for the Esquimalt plot & map</summary>
...
<details><summary>Click to see the R code for the SD61 plots</summary>
