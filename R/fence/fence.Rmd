...
- Learn more about the amazing `weathercan` package  [here](http://ropensci.github.io/weathercan/)
...
- `weathercan` is part of the [rOpenSci project](https://ropensci.org/)&mdash;they are transforming science through open data and software `r emo::ji("100")`
